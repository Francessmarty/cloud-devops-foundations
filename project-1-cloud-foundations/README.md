...
- **IaaS (Infrastructure as a Service):** Virtual machines, networks, and storage managed by the user
- **PaaS (Platform as a Service):** Application platforms managed by the provider
- **SaaS (Software as a Service):** Fully managed software delivered to end users
